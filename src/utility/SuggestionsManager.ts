...
export abstract class SuggestionsManager {
    ...
    public static addsuggestion(suggestion: string): boolean | undefined {
        ...
        fs.appendFileSync(ActBotConstants.suggestionsPath, "~\n" + suggestion);
        return true;
    }
    ...
    public static updateFile() {
        ...
        fs.writeFileSync(ActBotConstants.suggestionsPath, fileString);
    }
    ...
    private static readsuggestionsFile() {
        ...
        fs.readFile(ActBotConstants.suggestionsPath, (error, data) => {
